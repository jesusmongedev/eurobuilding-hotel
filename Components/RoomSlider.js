...
const RoomSlider = ({ room_title, room_image, room_price }) => {
  ...
  return (
    <div className="max-w-[328px] min-w-[320px] sliderCards mt-6">
      <div className="relative flex flex-col background w-[320px] min-h-[328px] py-3  bg-no-repeat bg-contain rounded-md text-white">
